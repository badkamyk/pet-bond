export const cardData = [
    {
        ...
        description: "In the adoption section, you can search for a pupil. You'll find there information about pupils' age, breed, and other details."
    },
    {
        ...
        description: 'You can choose a pupil by clicking on the "Adopt" button. After that, you will be redirected to the adoption form.'
    },
    {
        ...
        title: 'Fill the form',
        description: 'Fill the form with your personal data and information about your home. After that, we will contact you to arrange a meeting with your new friend.'
    }
]